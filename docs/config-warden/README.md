# Config Warden — Documentation

_Core Systems Asset Factory (CSAF). This page is the free, public documentation for this product — no purchase required to read it._


**Product:** Config Warden  
...
4. [The commandlet](#the-commandlet)
5. [The four verdicts](#the-four-verdicts)
6. [The `-Apply` safety model](#the-apply-safety-model)
7. [Rule sets](#rule-sets)
8. [Running in CI](#running-in-ci)
9. [Reports](#reports)
10. [Scope limits](#scope-limits)
11. [What Unreal already ships](#what-unreal-already-ships)
